...
export default function OnboardingStep5() {
  const [primaryLocation, setPrimaryLocation] = useState("350 5th Avenue, Suite 2100, New York, NY 10118");
    ...
    >
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-3">
          <h2 className="text-xl font-bold text-black">Enter your business locations?</h2>
        ...
        {additionalLocations.map((location, index) => (
          <div key={index} className="flex flex-col gap-3">
            <h3 className="text-xl font-bold text-black">Location {index + 3}</h3>
