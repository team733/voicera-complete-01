                ...
                <div className="w-[500px] bg-white rounded-2xl border border-gray-200 p-5">
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 border border-gray-200 rounded-xl p-3 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M20 18.1C20 22.0765 16.866 25.3 13 25.3M13 25.3C9.134 25.3 6 22.0765 6 18.1M13 25.3V28M13 28H15.625M13 28H10.375M17.375 14.5V18.1C17.375 20.5853 15.416 22.6 13 22.6C10.584 22.6 8.625 20.5853 8.625 18.1V14.5C8.625 12.0147 10.584 10 13 10C15.416 10 17.375 12.0147 17.375 14.5Z" stroke="black" strokeWidth="1.5" strokeLinecap="round"/>
                      </svg>
                    </button>
                    <button className="flex-1 border border-gray-200 rounded-xl p-3 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
