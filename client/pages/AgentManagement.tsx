        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-3 px-4 py-2 border border-gray-200 rounded-xl bg-white">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
                d="M16.6743 1.66699V4.27715C16.6743 4.52203 16.3681 4.63289 16.2114 4.44477C14.6855 2.73991 12.468 1.66699 9.99996 1.66699C5.39758 1.66699 1.66663 5.39795 1.66663 10.0003C1.66663 14.6027 5.39758 18.3337 9.99996 18.3337C14.6023 18.3337 18.3333 14.6027 18.3333 10.0003"
                stroke="#141B34"
                strokeWidth="1.25"
                strokeLinecap="round"
    ...
    <div className="space-y-5">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-lg font-semibold text-gray-500">
            Customize how your AI assistant communicates and engages with
            customers.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-3 px-4 py-2 border border-gray-200 rounded-xl bg-white">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
                d="M16.6744 1.66699V4.27715C16.6744 4.52203 16.3682 4.63289 16.2115 4.44477C14.6856 2.73991 12.4682 1.66699 10.0001 1.66699C5.39771 1.66699 1.66675 5.39795 1.66675 10.0003C1.66675 14.6027 5.39771 18.3337 10.0001 18.3337C14.6024 18.3337 18.3334 14.6027 18.3334 10.0003"
                stroke="#141B34"
                strokeWidth="1.25"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <select className="w-full px-4 py-4 border-2 border-gray-200 rounded-xl text-lg text-gray-500 appearance-none bg-white">
                  <option>
                    Warm & Reassuring: "Hello, you're through to [Business
                    Name]. I'm here to help, how can I assist?"
                  </option>
                </select>
                <svg
                  className="absolute right-4 top-1/2 transform -translate-y-1/2"
    ...
    <div className="space-y-5">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-lg font-semibold text-gray-500">
            Manage the information your AI agent uses to answer questions
            accurately.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-3 px-4 py-2 border border-gray-200 rounded-xl bg-white">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
                d="M16.6747 1.66699V4.27715C16.6747 4.52203 16.3685 4.63289 16.2117 4.44477C14.6858 2.73991 12.4684 1.66699 10.0003 1.66699C5.39795 1.66699 1.66699 5.39795 1.66699 10.0003C1.66699 14.6027 5.39795 18.3337 10.0003 18.3337C14.6027 18.3337 18.3337 14.6027 18.3337 10.0003"
                stroke="#141B34"
                strokeWidth="1.25"
                strokeLinecap="round"
                strokeLinejoin="round"
    ...
    <div className="space-y-5">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-lg font-semibold text-gray-500">
            Fine-tune your AI agent's behavior, integrations, and system
            controls.
          </p>
        </div>
        <div className="flex items-center gap-3">
    ...
    <div className="space-y-5">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-lg font-semibold text-gray-500">
            Control how your calls and appointments are scheduled and managed.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-3 px-4 py-2 border border-gray-200 rounded-xl bg-white">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
                d="M16.6742 1.66699V4.27715C16.6742 4.52203 16.368 4.63289 16.2113 4.44477C14.6853 2.73991 12.4679 1.66699 9.99984 1.66699C5.39746 1.66699 1.6665 5.39795 1.6665 10.0003C1.6665 14.6027 5.39746 18.3337 9.99984 18.3337C14.6022 18.3337 18.3332 14.6027 18.3332 10.0003"
                stroke="#141B34"
                strokeWidth="1.25"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      <main className="px-16 py-8">
        ...
        <div className="flex justify-between items-center mb-5">
          <div className="flex items-center gap-3">
            ...
            <div
              className={`flex items-center gap-3 px-4 py-1 border rounded-full ${
                isAgentLive
            ...
            <div className="flex gap-7">
                ...
                <div className="flex-1 flex flex-col justify-center items-center">
                  {testCalls.length === 0 ? (
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-xl font-semibold text-gray-500">
                        Start a test call to login conversation
                      </p>
                    </div>
                  ) : (
              ...
              <div className="flex flex-col gap-7">
                ...
                <div className="w-[500px] bg-white rounded-2xl border border-gray-200 p-5">
                  <h2 className="text-xl font-semibold text-black mb-7">
                    Call Controls
                  </h2>
              ...
              {Array.from({ length: 72 }, (_, i) => (
                <div
                  ...
                  style={{
                    ...
                    animation:
                      i < 32
                        ? `pulse ${Math.random() * 0.5 + 0.5}s infinite alternate`
                        : "none",
                  }}
                />
              ))}
                ...
                <div className="flex-1">
                  <p className="text-xl text-black">
                    ...
                    <span className="text-gray-500">
                      Your AI agent settings have been successfully updated.
                    </span>
                  </p>
              ...
              <div className="flex items-start gap-4 pb-4 border-b border-gray-200">
                ...
                <div className="flex-1">
                  <p className="text-xl text-black">
                    ...
                    <span className="text-gray-500">
                      Agent testing session has been completed successfully.
                    </span>
                  </p>
