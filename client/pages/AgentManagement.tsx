                ...
                <div className="w-[500px] bg-white rounded-2xl border border-gray-200 p-5">
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 border border-gray-200 rounded-xl p-3 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M12 18.1C12 22.0765 8.866 25.3 5 25.3M5 25.3C1.134 25.3 -2 22.0765 -2 18.1M5 25.3V28M5 28H7.625M5 28H2.375M9.375 14.5V18.1C9.375 20.5853 7.416 22.6 5 22.6C2.584 22.6 0.625 20.5853 0.625 18.1V14.5C0.625 12.0147 2.584 10 5 10C7.416 10 9.375 12.0147 9.375 14.5Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" transform="translate(7, -6)"/>
                      </svg>
                    </button>
                    <button className="flex-1 border border-gray-200 rounded-xl p-3 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M18.5 15.625C19.188 16.5471 19.6 17.7213 19.6 19C19.6 20.2787 19.188 21.4528 18.5 22.375M21.8 13.375C23.176 14.9119 24 16.8689 24 19C24 21.1311 23.176 23.0881 21.8 24.625M15.2 22.1652V15.8348C15.2 12.2964 15.2 10.5272 14.182 10.087C13.164 9.64667 11.966 10.8977 9.571 13.3997C8.33 14.6954 7.622 14.9823 5.857 14.9823C4.313 14.9823 3.541 14.9823 2.986 15.3692C1.835 16.1724 2.009 17.7422 2.009 19C2.009 20.2577 1.835 21.8276 2.986 22.6308C3.541 23.0177 4.313 23.0177 5.857 23.0177C7.622 23.0177 8.33 23.3047 9.571 24.6004C11.966 27.1024 13.164 28.3534 14.182 27.913C15.2 27.4727 15.2 25.7035 15.2 22.1652Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" transform="translate(-2, -7)"/>
                      </svg>
                    </button>
                  </div>
                </div>
