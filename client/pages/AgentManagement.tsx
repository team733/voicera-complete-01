                ...
                <div className="w-[500px] bg-white rounded-2xl border border-gray-200 p-5">
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 border border-gray-200 rounded-xl p-3 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M17 8.5C17 11.2614 14.7614 13.5 12 13.5M12 13.5C9.23858 13.5 7 11.2614 7 8.5M12 13.5V16M12 16H14.25M12 16H9.75M15.75 6V8.5C15.75 10.7091 13.9591 12.5 11.75 12.5C9.54086 12.5 7.75 10.7091 7.75 8.5V6C7.75 3.79086 9.54086 2 11.75 2C13.9591 2 15.75 3.79086 15.75 6Z" stroke="black" strokeWidth="1.5" strokeLinecap="round"/>
                      </svg>
                    </button>
                    <button className="flex-1 border border-gray-200 rounded-xl p-3 flex items-center justify-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M21 15.625C21.75 17.1417 22.5 19.0125 22.5 21C22.5 22.9875 21.75 24.8583 21 26.375M24 12.375C25.5 14.8981 26.5 17.8731 26.5 21C26.5 24.1269 25.5 27.1019 24 29.625M19.5 23.1652V16.8348C19.5 13.2964 19.5 11.5272 18.482 11.087C17.464 10.6467 16.266 11.8977 13.871 14.3997C12.63 15.6954 11.922 15.9823 10.157 15.9823C8.613 15.9823 7.841 15.9823 7.286 16.3692C6.135 17.1724 6.309 18.7422 6.309 21C6.309 23.2577 6.135 24.8276 7.286 25.6308C7.841 26.0177 8.613 26.0177 10.157 26.0177C11.922 26.0177 12.63 26.3047 13.871 27.6004C16.266 30.1024 17.464 31.3534 18.482 30.913C19.5 30.4727 19.5 28.7035 19.5 25.1652Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </button>
                  </div>
                </div>
