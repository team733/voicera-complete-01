    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col items-center px-4 py-16">
      ...
      <div className="w-full max-w-lg bg-white rounded-[28px] border-2 border-[#E5E7EB] p-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-black mb-2">Welcome to Voicera AI</h2>
          <p className="text-xl text-[#737373]">Please enter your details to sign in</p>
        </div>
              ...
              >
                {rememberMe && (
                  <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 4.5L4.5 8L11 1.5" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                )}
              </button>
              <span className="text-xl text-black">Remember me</span>
            </div>
            <Link to="/forgot-password" className="text-xl text-black underline">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="text-center mt-7">
          <span className="text-xl text-[#6B7280]">Don't have an account? </span>
