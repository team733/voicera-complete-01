    ...
    <div className="fixed inset-0 bg-black bg-opacity-20 flex justify-center items-center z-50">
      <div className="bg-white rounded-2xl w-[600px] shadow-lg">
        ...
        <div className="flex justify-between items-center p-5 border-b border-gray-200">
          ...
          <button onClick={() => setShowSummaryPopup(false)} className="text-gray-500 hover:text-gray-700">
        ...
        <div className="p-5 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-5">
              <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                ...
                <span className="text-lg font-semibold text-black">6 Calls</span>
              </div>
              <div className="flex justify-between items-center pb-3 border-b border-gray-200">
              ...
              <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                ...
                <span className="text-lg font-semibold text-black">4 Bookings</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-lg text-gray-500">Missed Calls:</span>
                <span className="text-lg font-semibold text-black">0 Missed</span>
              </div>
            </div>
          </div>
          ...
          {/* Additional Insights */}
          <div className="space-y-3">
            <h4 className="text-xl font-medium text-gray-800">Additional Insights:</h4>
            <div className="space-y-5">
              <div className="flex justify-between items-center pb-3 border-b border-gray-200">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-semibold text-black">11:00 AM – 1:00 PM</span>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-[#F9FAFB]">
        ...
        <div className="flex items-center justify-center mt-4">
          <div className="bg-gray-100 rounded-full p-2 flex items-center gap-3">
            ...
            <div className="bg-white px-4 py-2 rounded-full shadow-sm">
              <span className="text-lg font-semibold text-black">Daily Summary</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="px-16 py-8">
        ...
        <div className="flex justify-between items-end mb-7">
          <div>
            <h1 className="text-3xl font-semibold text-black mb-1">Daily Summary</h1>
            <p className="text-xl font-semibold text-gray-500">Review and analyze the day's call performance at a glance.</p>
          </div>
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="flex items-center gap-4 p-3 bg-gray-100 border-b border-black border-opacity-10">
            ...
            <div className="w-8 text-xs font-bold text-gray-700 uppercase tracking-wide">NO.</div>
            <div className="flex-1 text-xs font-bold text-gray-700 uppercase tracking-wide">DATE</div>
            <div className="flex-1 text-xs font-bold text-gray-700 uppercase tracking-wide">CALLS TAKEN</div>
            <div className="flex-1 text-xs font-bold text-gray-700 uppercase tracking-wide">AVG DURATION</div>
            <div className="flex-1 text-xs font-bold text-gray-700 uppercase tracking-wide">BOOKINGS MADE</div>
            <div className="flex-1 text-xs font-bold text-gray-700 uppercase tracking-wide">MISSED</div>
            <div className="flex-1 text-xs font-bold text-gray-700 uppercase tracking-wide">ACTION</div>
          </div>
          ...
          {dailySummaryEntries.map((entry, index) => (
            ...
            >
              <div className="w-4 h-4 border border-gray-300"></div>
              <div className={`w-8 font-semibold text-gray-700 ${entry.id === '06' ? 'text-xs' : 'text-sm'}`}>
                {entry.id}
              </div>
              <div className={`flex-1 text-gray-700 ${entry.id === '06' ? 'text-xs font-semibold uppercase' : 'text-sm'}`}>
                {entry.date}
              </div>
              <div className={`flex-1 text-gray-700 ${entry.id === '06' ? 'text-xs font-semibold uppercase' : 'text-sm'}`}>
              ...
              <div className={`flex-1 text-gray-700 ${entry.id === '06' ? 'text-xs font-semibold uppercase' : 'text-sm'}`}>
                {entry.bookingsMade} Booking{entry.bookingsMade !== 1 ? 's' : ''}
              </div>
              <div className={`flex-1 text-gray-700 ${entry.id === '06' ? 'text-xs font-semibold uppercase' : 'text-sm'}`}>
                {entry.missed} Missed
              </div>
